...
public class ImagePreviewFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mImageView = (ImageView) v.findViewById(R.id.image_detail_image);
        mProgressBar = (ProgressBar) v.findViewById(R.id.image_detail_loading);
        mWaterView = (TextView) v.findViewById(R.id.image_detail_water);
