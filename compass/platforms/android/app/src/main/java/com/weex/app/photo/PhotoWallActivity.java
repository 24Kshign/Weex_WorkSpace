...
import com.weex.app.permision.PermissionHandler;
import com.weex.app.util.AlertToast;
import com.weex.app.util.FileUtil;
import com.weex.app.util.ImageUtil;
import com.weex.app.util.LogUtil;
import com.weex.app.util.RxBus;
import com.weex.app.util.SizeUtil;
...
//            finish();
    ...
    private void commit() {
        ...
        //专门为chooseImage准备的事件
        com.maihaoche.volvo.ui.common.daomain.ChoosePicEvent choosePicEvent = new com.maihaoche.volvo.ui.common.daomain.ChoosePicEvent();
        choosePicEvent.tag = mTag;
        if (isMultiple) {
            choosePicEvent.type = com.maihaoche.volvo.ui.common.daomain.ChoosePicEvent.TYPE_MULTI;
            choosePicEvent.pathList.addAll(mSelectionList);
        } else {
            choosePicEvent.type = com.maihaoche.volvo.ui.common.daomain.ChoosePicEvent.TYPE_SINGLE;
