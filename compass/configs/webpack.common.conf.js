...
const weexEntry = {
  ...
  'HomePage': helper.root('entry/HomePage.js'),
  'SettingPage': helper.root('entry/SettingPage.js'),
  'AddWareHousePage': helper.root('entry/AddWareHousePage.js'),
  'EditWareHousePage': helper.root('entry/EditWareHousePage.js'),
  'ForgetPwdPage': helper.root('entry/ForgetPwdPage.js'),
  'InventoryRecordPage': helper.root('entry/InventoryRecordPage.js'),
  'WareHousePage': helper.root('entry/WareHousePage.js'),
  'InboundHomePage': helper.root('entry/InboundHomePage.js'),
  'InventoryDetailsPage': helper.root('entry/InventoryDetailsPage.js')
}
